...
from courses.permissions import IsSubscribe, IsAuthor
from courses.serializers import CourseDetailSerializer, CourseCreateSerializer, CourseListSerializer
