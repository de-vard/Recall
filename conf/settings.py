...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=25),  # продолжительность жизни токена ACCESS
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),  # продолжительность жизни токена REFRESH
